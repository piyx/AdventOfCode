...
eparated by spaces or newlines. Passports are separated by blank lines.
...
so it looks like data from North Pole Credentials, not a
passport at all! Surely, nobody would mind if you made the
...
required fields. Treat cid as optional.
...
Count the number of valid passports - those that have all
required fields and valid values. Continue to treat cid as optional.
In your batch file, how many passports are valid?
```

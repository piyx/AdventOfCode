...
FBFBBFFRLR, where F means "front", B means "back",
...
(64 through 127). The next letter indicates which half of
...
again, this time with only three steps. L means
...
the only missing boarding pass in your list. However,
there's a catch: some of the seats at the very front and back
of the plane don't exist on this aircraft,
